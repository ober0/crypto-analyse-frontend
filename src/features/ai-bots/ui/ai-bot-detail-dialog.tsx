...
import { CandlestickChart, FileText, ListOrdered, ScrollText } from 'lucide-react'
import type { ReactNode } from 'react'
import { useState } from 'react'
import { formatBotModel } from '../lib/labels'
import { AiBotChartTab } from './ai-bot-chart-tab'
...
type DetailTab = 'trades' | 'chart' | 'logs' | 'info'
                ...
                {!isLoading && bot && (
                    <div className="flex min-h-0 flex-1 flex-col">
                        ...
                        <div className="min-h-0 flex-1 overflow-y-auto px-4 py-4 sm:px-6 sm:py-5">
                            ...
                            {tab === 'chart' && (
                                <AiBotChartTab
                                    symbolId={bot.tickersId}
                                    tickerName={bot.ticker.name}
                                    trades={bot.trades}
                                />
                            )}
